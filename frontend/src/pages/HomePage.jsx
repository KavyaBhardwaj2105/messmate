...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-12 pb-20 sm:pt-20 sm:pb-28 bg-gradient-to-b from-brand-50/70 via-[#FBFBFA] to-[#FBFBFA]">
        {/* Subtle decorative circles */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-tr from-brand-200/30 to-amber-200/20 rounded-full blur-3xl pointer-events-none -z-10" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-brand-200 shadow-sm text-xs font-bold text-brand-700 mb-6"
          >
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl text-slate-600 max-w-2xl mx-auto font-normal leading-relaxed mb-10"
          >
          ...
          <motion.form
            ...
            className="max-w-2xl mx-auto bg-white p-2.5 sm:p-3 rounded-3xl border border-slate-200/90 shadow-lifted flex flex-col sm:flex-row items-center gap-2.5 mb-6"
          >
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 text-sm text-slate-900 bg-transparent rounded-2xl focus:outline-none placeholder:text-slate-400"
              />
            </div>
            <button
              type="submit"
          ...
          {/* Quick City Filters */}
          <div className="flex items-center justify-center flex-wrap gap-2 text-xs font-semibold text-slate-500 mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/explore"
              className="w-full sm:w-auto px-7 py-3 rounded-2xl font-bold text-sm text-white bg-slate-900 hover:bg-slate-800 shadow-md shadow-slate-900/10 transition-all flex items-center justify-center gap-2"
            >
            ...
            <Link
              to="/add-hostel"
              className="w-full sm:w-auto px-7 py-3 rounded-2xl font-bold text-sm text-slate-700 bg-white border border-slate-200 hover:border-brand-300 hover:text-brand-600 shadow-soft transition-all flex items-center justify-center gap-2"
            >
      ...
      <section className="py-12 bg-white border-y border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-100 flex items-start gap-4">
              <div className="p-3 rounded-xl bg-brand-100 text-brand-800">
